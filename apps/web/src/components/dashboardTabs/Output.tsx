...
import { Badge } from '@visualnote/shadcn-ui/components/ui/badge';
...
function Output(props: Props): JSX.Element {
  const data = {
    ...
    examples: [
      {
        id: 1,
        text: "To list all tuples in the 'Works' relation for all persons who work for 'Waelhi Company'",
        query: "σ(company-name='Waelhi Company')(Works)",
      },
      {
        id: 2,

        text: "Find names of persons working at 'Waelhi Company' who earn more than Php 50,000",
        query:
      ...
      },
      {
        ...
        text: "Find names and cities of persons who work for 'Waelhi Company' and earn more than Php 50,000",
        query:
      ...
      },
      {
        ...
        text: 'Find names of all persons who live in the same city as the company they work for',
        query:
      ...
      },
      {
        ...
        text: 'Find names of all persons who live in the same city and on the same street as their manager',
        query:
